...
제 목표는 언젠가 Anti-Cheat Engineer로 활동하며, 개발자들이 애써 만든 게임이 부정 행위로 망가지는 것을 막는 것입니다. 
강력한 보안 시스템을 설계하고, 혁신적인 방법으로 치팅을 차단하여 전 세계의 게이머들이 공정한 환경에서 게임을 즐길 수 있도록 돕고 싶습니다.
...
- **아바 온라인 (AVA)**: XXXX시간 플레이
        - *전략적 팀워크와 빠른 결정이 필요한 FPS, 최고의 승리 경험과 치열한 경쟁을 추구합니다.*
   
- **리그 오브 레전드 (League of Legends)**: XXXX시간 플레이
        - *팀 기반의 MOBA에서 끊임없는 도전과 기술 향상을 통해 승리의 쾌감을 맛보았습니다.*
  
- **레인보우 식스 시즈 (Rainbow Six Siege)**: XXXX시간 플레이
        - *전술적 FPS의 진수를 경험하며, 각 라운드마다 신중하고 치밀한 플레이를 전개합니다.*
  
- **이스케이프 프롬 타르코프 (Escape from Tarkov)**: XXXX시간 플레이
        - *고난도의 생존 슈팅 게임에서 정확성과 생존력을 테스트하며 실력을 단련합니다.*

🔒 목표 및 비전
    현재 정보보안 기술을 학습하며, 게임의 공정성을 지키기 위해 노력하고 있습니다. 
    **Anti-Cheat Engineer**로서, 게임 생태계를 보호하고 열정을 담은 게임의 재미와 균형을 유지하는 보안 전문가로 성장하고자 합니다.
