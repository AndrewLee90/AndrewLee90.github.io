...
20년 가까이 게임을 즐겨온 **코어 게이머**로서, 게임의 본질적인 재미와 공정성을 해치는 부정 행위를 **절대 용납할 수 없다는 신념**을 가지고 있습니다.  
이러한 문제의 근원을 해결하고자 **정보보안 분야**에 뛰어들었으며, 복잡한 시스템의 무결성을 보호하고 잠재적 위협을 예측하는 **고도의 분석적 사고**를 길러왔습니다.

> **목표:**  
> 게임의 '재미(Fun)'와 '사용자 만족'을 보장하는 FQA 전문가로 성장하여,  
> 모든 게이머가 신뢰할 수 있는 환경을 만드는 데 기여하는 것.
...
- **리버스 엔지니어링 도구 활용:**  
  Ghidra, IDA Pro를 통해 메모리 변조, 패킷 탈취 등 게임 위협 요소 분석  
- **UX 기반 문제 인지:**  
  수천 시간의 실제 플레이 경험 기반으로, 유저 불만 요소에 대한 깊은 이해
...
- **QA 워크플로우 경험:**  
  Jira, Bugzilla 등의 버그 트래킹 도구 활용, 이슈 관리 및 테스트 계획 수립 경험  
- **테스트 자동화:**  
  Python을 활용해 반복 테스트 자동화 → QA 프로세스 효율화
...
- **기술적 커뮤니케이션:**  
  개발자/기획자와의 효과적인 협업을 통해 문제 해결  
- **기록 및 문서화:**  
  Notion, 블로그 활용 → 기술적 노하우 및 테스트 케이스 명확히 정리

---

## 🎯 주요 관심 분야 (Security Research)

### 📡 ESP (Extra Sensory Perception)
- **내용:** 비정상적인 위치/아이템 표시 기능
- **분석:** 게임 메모리 구조 분석, 네트워크 패킷 추적  
- **대응:** 오버레이 탐지, 화면 데이터 변경 감지

---

### 🎯 AIMBOT (자동 조준)
- **내용:** 비정상 조준 자동화 치트
- **분석:** 마우스 이벤트 분석, 픽셀 기반 조준 탐지  
- **대응:** AI 기반 비정상 패턴 인식

---

### 🛠 메모리 변조 (Memory Hacking)
- **내용:** 메모리 값을 조작해 게임 밸런스 붕괴
- **분석:** Cheat Engine 탐지, 무결성 검사  
- **대응:** ASLR, 메모리 암호화

---

### 🌐 서버 정보 탈취
- **내용:** 패킷 스니핑을 통한 서버 구조 분석  
- **분석:** 세션 인증, 암호화 필요성 강조  
- **대응:** SSL/TLS 강화, 패킷 요청 패턴 분석

---

### 🔄 리버싱 (Reversing)
- **내용:** 코드 분석을 통한 치트 제작
- **분석:** 디컴파일링, 난독화 및 방어 기술 연구  
- **대응:** Anti-Debugging, 실행 시간 조작 탐지

---

### 🕵️ Ghidra
- **활용:** 오픈소스 리버스 엔지니어링 툴  
- **내용:** 게임 바이너리 분석, 플러그인 개발로 치트 탐지 역량 강화

---

### 👩 IDA Pro
- **활용:** 상용 리버싱 도구  
- **내용:** IDAPython 활용 자동 분석 및 탐지 스크립트 개발

---

### 🎮 언리얼 엔진 (Unreal Engine)
- **활용:** C++, 블루프린트로 게임 시스템 분석 및 개발  
- **연구:** 리플리케이션, 메모리 무결성 검증, 비정상 접근 탐지 로직 개발
...
| 게임 | 플레이 시간 | 특징 |
|------|--------------|------|
| **AVA (아바 온라인)** | 2000시간 | 병과별 전략, 팀 기반 FPS |
| **LoL (리그 오브 레전드)** | 드레이븐 130만, 갱플랭크 100만 숙련도 | MOBA 전략, 포지셔닝 |
| **Rainbow Six Siege** | 2000시간 | 전술 FPS, HB 전문 |
| **Escape from Tarkov** | 2500시간 | 생존 FPS, 2시즌 카파 달성 |

> 실제 유저의 시선에서 **재미 요소와 불편 요소를 명확하게 인지**할 수 있는 능력 보유

---

## 📌 목표 및 비전

정보보안 기술과 게이머의 시각을 융합하여  
게임 본연의 재미를 지키는 FQA 전문가가 되는 것이 저의 최종 목표입니다.
...
- **이름:** 이성훈  
- **이메일:** [only4clovers@naver.com](mailto:only4clovers@naver.com)  
- **전화번호:** 010-3827-0294  
...
### 💻 언어 & 백엔드
- Python (3.10~3.13) – 보안 자동화, 스크립팅  
- C / C++ – 시스템 프로그래밍 학습 중  
- FastAPI – REST API 서버 및 Swagger 문서화  
- Bash – 기본 자동화 스크립트

---

### 🔍 리버싱 & 디버깅
- gdb, x64dbg – 디버깅 및 동적 분석  
- IDA Pro – 어셈블리 기반 정적 분석  
- Ghidra – 바이너리 분석, 치트 탐지  
- Cheat Engine – 게임 메모리 분석

---

### 🧠 AI & 추론 시스템
- ClovaX – 압축 파일 패스워드 추론  
- LLaMA – 로컬 LLM 테스트 및 비교 분석

---

### 🔐 보안 자동화
- VirusTotal API – 악성코드 해시 분석  
- py7zr, rarfile – 압축 해제 자동화  
- ZIPSentinel – 자동 게시글 분석/차단 시스템 개발

---

### ⚙️ 인프라 & 협업
- OS: Ubuntu 22.04 / Rocky Linux  
- Docker – 서버 환경 구축 및 배포  
- Naver Cloud – 클라우드 인프라 설정  
- GitHub – 코드 관리 및 협업  
- Notion / Blog – 기술 문서화
...
### 🎨 기타
- Unreal Engine 5 – 더미 맵 제작, 블루프린트 구조 이해  
- Sony Vegas / DaVinci Resolve – 영상 편집 중급  
- Office – Word, Excel, PPT 중급 활용

---

## 🎯 관심 분야
**게임 보안 | 안티치트 솔루션 | FQA | 리버스 엔지니어링 | 사용자 경험 기반 테스트**

---

> 💡 *"정당한 승리만이 진짜 재미를 만든다"*  
> 당신의 게임에서 공정함을 지키는 조력자가 되겠습니다.
...
### 14. 가상화폐 데이터 저장 <a id="project14"></a>
